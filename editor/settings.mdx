...
description: "Configure AI instructions, pull request defaults, draft behavior, and the default merge method to control how the Doxa web editor publishes changes."
...
You need admin access to your Doxa deployment to change publishing settings.
