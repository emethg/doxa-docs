...
description: "Reorder pages, add groups, and manage your documentation sidebar structure using drag-and-drop in the Doxa web editor — no docs.json edits needed."
