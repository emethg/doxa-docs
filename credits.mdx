...
description: "Understand how Doxa credits work for assistant messages, agent runs, and workflows. How credit tiers, overages, and rollovers are billed."
keywords: ["credits", "billing", "pricing", "AI chat", "messages", "tiers", "usage"]
---

Some Doxa features consume credits.

* Assistant responses
* Agent runs in the editor or on Slack
* Workflow runs

For the most current pricing information, see the [Pricing page](https://doxa.com/pricing) or view the [Usage](https://app.doxa.com/settings/organization/usage) page in your dashboard.
...
<Note>
  Overages are disabled by default. You must enable them on the [Usage](https://app.doxa.com/settings/organization/usage) page of your dashboard.
</Note>
...
For high-volume usage or custom credit packages, [contact sales](mailto:sales@doxa.com). Custom credit packages are available on enterprise plans only.
...
**Monitor your usage patterns.** The [Usage](https://app.doxa.com/settings/organization/usage) page in your dashboard shows a breakdown by feature category. If a particular workflow is consuming more credits than expected, review its trigger or any custom instructions.
