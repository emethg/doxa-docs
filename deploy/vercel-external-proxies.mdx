...
description: "Configure external reverse proxies like Cloudflare or Nginx in front of your Vercel deployment to serve Doxa docs at a custom subpath."
...
- `/doxa-assets/_next/static/*` - Required for static assets
