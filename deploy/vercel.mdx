---
title: "Vercel"
description: "Configure Vercel rewrites to serve your Doxa documentation at a subpath on your main domain with step-by-step vercel.json setup."
...
3. Enter your domain.
4. Click **Add domain**.
5. Add the following rewrites to your `vercel.json` file. Replace `[subdomain]` with your subdomain, which appears at the end of your dashboard URL. For example, `app.doxa.com/your-organization/your-subdomain` has a domain identifier of `your-subdomain`.
