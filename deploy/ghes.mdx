...
description: "Install and configure the Doxa GitHub App on your GitHub Enterprise Server instance for automated documentation deployments and syncing."
keywords: ["GitHub Enterprise Server", "GHES", "GitHub Enterprise"]
---

This guide walks you through setting up the Doxa GitHub App on your GitHub Enterprise Server (GHES) installation. To connect a GHES instance to Doxa, you must create a local version of our app within your self-hosted environment that communicates with our remote server.
...
- Doxa's API endpoints (https://leaves.doxa.com)
- Webhook receivers (port 443)

#### Firewall configuration

The following outbound connections must be allowed:
- Connections from Doxa's static IP: `54.242.90.151`
- HTTPS (port 443) to Doxa's service domains
- DNS resolution for Doxa's service domains
...
- **Webhook URL:** `https://leaves.doxa.com/github-enterprise/:subdomain` (replace `:subdomain` with the URL that we provide you with)
- **Webhook secret:** Generate a random string (32+ characters) and record it securely. Doxa can also generate this and provide it to you.
</Step>
</Steps>
...
- Integrate your GHES environment with an existing Doxa deployment.
- Integrate your GHES environment with a new Doxa deployment that we provision for you.

After your GHES environment is integrated with a Doxa deployment, you are ready to enable webhooks for your GitHub App.
...
2. Verify that Doxa responds appropriately.
</Step>
</Steps>
...
Reach out to your customer success representative at Doxa, or contact our support team at <a href="mailto:support@doxa.com">support@doxa.com</a> with:
