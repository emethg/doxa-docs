...
description: "Configure the documentation path and content directory in a monorepo project so Doxa deploys only from your designated docs folder."
keywords: ["monorepo", "content directory", "multi-project repository"]
---

Configure Doxa to deploy documentation from a specific directory within a monorepo. This setup lets you maintain documentation alongside your code in repositories that contain multiple projects or services.
...
* Admin access to your Doxa project.
...
Navigate to [Git Settings](https://app.doxa.com/settings/deployment/git-settings) in your dashboard.
