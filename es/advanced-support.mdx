...
- Todos los clientes reciben soporte a través del dashboard o support@doxa.com (respuesta en 24 horas)
...
Incluido con todos los planes Pro y Enterprise. Envía solicitudes a través del dashboard o por correo electrónico a support@doxa.com. Recibirás una primera respuesta en un plazo de 24 a 48 horas.
...
- Canal de Slack para tu equipo y los ingenieros de soporte de Doxa
- SLA de primera respuesta de 24 horas
- Escalamiento prioritario de errores al equipo de ingeniería de Doxa
...
<AccordionGroup>
  <Accordion title="¿Cuál es la diferencia entre un CSM dedicado y el soporte estándar?">
    Ofrecemos el soporte estándar a través del dashboard o support@doxa.com con un SLA de respuesta de 24-48 horas. Un CSM dedicado incluye tanto un punto de contacto principal como un canal de Slack dedicado. Las principales diferencias son:
...
<AccordionGroup>
  <Accordion title="¿Cuál es la diferencia entre el Soporte avanzado en Slack y el soporte estándar?">
    Ofrecemos el soporte estándar (incluido con los planes Pro y Enterprise) a través del dashboard o support@doxa.com con un SLA de respuesta de 24 a 48 horas. El Soporte avanzado en Slack incluye:
...
Ponte en contacto con tu equipo de cuentas de Doxa para añadir Advanced Slack Support o un Dedicated CSM, o escribe a gtm@doxa.com.