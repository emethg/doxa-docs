...
description: "Comprende los conceptos de control de versiones de Git que hay detrás del editor de Doxa, incluyendo branches, commits, pull requests y flujos de trabajo de fusión."
...
|---|---|
| Editar una página | Los cambios se guardan automáticamente en los servidores de Doxa (aún no hay commit de Git) |
