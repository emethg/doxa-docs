...
description: "Reordena las páginas, agrega grupos y gestiona la estructura de la barra lateral de tu documentación con arrastrar y soltar en el editor web de Doxa, sin necesidad de editar docs.json."
