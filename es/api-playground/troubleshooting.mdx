...
<AccordionGroup>
  <Accordion title="Todas mis páginas de OpenAPI están completamente en blanco">
    En este escenario, es probable que Doxa no pueda encontrar tu documento de OpenAPI
    ...
    Este es exactamente el mismo paquete de validación que utiliza Doxa para validar documentos de OpenAPI, así que si tu documento
    pasa la validación aquí, hay muchas probabilidades de que el problema esté en otra parte.

    Además, Doxa no es compatible con OpenAPI 2.0. Si tu documento usa esta versión de la especificación,
  ...
  <Accordion title="Una de mis páginas de OpenAPI está completamente en blanco">
    ...
    <Note>
      Doxa resuelve automáticamente las diferencias de barra final entre tu referencia `openapi`
