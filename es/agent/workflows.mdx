...
1. Abre la página [Workflows](https://dashboard.doxa.com/products/workflows).
...
<Frame>
<img src="/images/workflows/workflow-settings-light.png" alt="La página de configuración del nuevo flujo de trabajo." className="block dark:hidden" />
<img src="/images/workflows/workflow-settings-dark.png" alt="La página de configuración del nuevo flujo de trabajo." className="hidden dark:block" />
</Frame>
...
Para repositorios de GitHub, debes tener instalada la aplicación de GitHub de Doxa en cada repositorio enumerado en los campos de contexto o disparador. Agrega nuevos repositorios en la página de la [aplicación de GitHub](https://dashboard.doxa.com/settings/organization/github-app) de tu dashboard de Doxa.

Para repositorios de GitLab, debes conectar tu cuenta de GitLab en la página de [GitLab OAuth](https://dashboard.doxa.com/settings/organization/gitlab-oauth) de tu dashboard de Doxa. Luego agrega los repositorios que deseas usar con los flujos de trabajo. Debes tener al menos el rol de Maintainer en cada proyecto para conectar GitLab OAuth.
...
<Note>
  Para repositorios de GitHub, la función automerge requiere que la aplicación GitHub de Doxa tenga permisos de bypass en todos los rulesets que apunten a tu rama de implementación, incluyendo rulesets a nivel de organización y a nivel de repositorio. Consulta [Configurar automerge](/es/guides/configure-automerge) para ver las instrucciones de configuración.

  Para repositorios de GitLab, la función automerge utiliza la conexión GitLab OAuth configurada en la página de [GitLab OAuth](https://dashboard.doxa.com/settings/organization/gitlab-oauth) de tu dashboard de Doxa. Debes tener al menos el rol de Maintainer en cada proyecto para conectar GitLab OAuth.
</Note>
...
<Note>
Las notificaciones de Slack requieren la aplicación Doxa Slack en el espacio de trabajo de Slack de tu organización. Instala la aplicación de Slack desde tu [dashboard](https://dashboard.doxa.com/products/agent).
</Note>
...
Edita, elimina, deshabilita o activa flujos de trabajo desde la página [Workflows](https://dashboard.doxa.com/products/workflows) en tu dashboard.
...
1. Ve a la página [Workflows](https://dashboard.doxa.com/products/workflows) en tu dashboard.
...
Cuando vuelves a habilitar un flujo de trabajo basado en cron, Doxa recalcula el próximo tiempo de ejecución a partir de la hora actual.
