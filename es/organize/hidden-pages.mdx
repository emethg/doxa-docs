...
<Note>
  ...
  Para incluirla de todos modos, configura `seo.indexing: "all"` en `docs.json`. Consulta [Búsqueda, SEO e indexación de IA](https://www.doxa.com/docs/#search-seo-and-ai-indexing) para más detalles.

  Nota: `noindex: true` solo afecta a la indexación; no oculta la página de la navegación. Consulta [Desactivar la indexación](https://www.doxa.com/docs/optimize/seo#disable-indexing) para obtener más información.
</Note>
