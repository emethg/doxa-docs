...
<ResponseField name="navbar.links" type="array of object">
  ...
  <Expandable title="navbar.links">
    ...
    <ResponseField name="label" type="string">
      Texto del enlace. Obligatorio cuando `type` no está definido. Opcional para `github` y `discord`. Si se omite, Doxa genera el texto a partir de los datos de la API.
    </ResponseField>
    <ResponseField name="href" type="string (uri)" required>
...
Variables globales para usar en toda tu documentación. Doxa reemplaza los marcadores de posición `{{variableName}}` con los valores definidos en tiempo de compilación.
...
<ResponseField name="variables.[variableName]" type="string">
  ...
  - Doxa sanitiza los valores para prevenir ataques XSS.
</ResponseField>
