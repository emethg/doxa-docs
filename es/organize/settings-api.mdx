...
<ResponseField name="api.params" type="object">
  ...
  <Expandable title="api.params">
    ...
    <ResponseField name="post" type="array of string">
      Claves de campos de la especificación OpenAPI que se mostrarán como píldoras post junto al nombre de cada parámetro en las páginas de referencia de la API y en el playground. Para cada clave que enumeres, Doxa lee el valor del esquema y lo renderiza como una píldora:
