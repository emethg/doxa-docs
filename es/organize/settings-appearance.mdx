...
<ResponseField name="styling.latex" type="boolean">
  Controla si se cargan las hojas de estilo de LaTeX. De forma predeterminada, Doxa detecta automáticamente el uso de LaTeX en tu contenido y carga las hojas de estilo necesarias.
