---
title: "Integraciones"
description: "Conecta plataformas de analítica, widgets de chat y servicios de terceros a tu sitio de documentación de Doxa a través de la configuración de integraciones en docs.json."
...
<ResponseField name="integrations.telemetry" type="object">
  Configuración de telemetría de Doxa.

  <Expandable title="integrations.telemetry">
    <ResponseField name="enabled" type="boolean">
      Si se habilita la telemetría de Doxa. Cuando se establece en `false`, las funciones de feedback también se deshabilitan y no aparecen en las páginas de tu documentación.
    </ResponseField>
  </Expandable>
</ResponseField>
