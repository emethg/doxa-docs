---
title: "GitHub"
description: "Conecta tu repositorio de GitHub a Doxa para despliegues automatizados, compilaciones de vista previa de pull requests y sincronización continua de la documentación."
keywords: ["GitHub App", "repository connection", "automated deployments"]
boost: 3
---

Doxa utiliza una Aplicación de GitHub para sincronizar automáticamente tu documentación con tu repositorio de GitHub.

<Tip>
  **¿Necesitas la Aplicación de GitHub?**

  - **Repositorio alojado en Doxa** en la organización `doxa-community`: No. La Aplicación de GitHub ya está configurada.
  ...
  Consulta tu repositorio en la página [Git Settings](https://dashboard.doxa.com/settings/deployment/git-settings) de tu dashboard.
</Tip>

Si tu repositorio es privado y pertenece a la organización Doxa, la Aplicación de GitHub está configurada y gestionada automáticamente por Doxa. Puedes usar el editor web para realizar cambios en tu documentación. Si quieres trabajar en tu documentación de forma local, clona el repositorio en tu propia organización y actualiza tu configuración de Git para usar tu propio repositorio.

<div id="clone-to-your-own-repository">
  ## Clonar en tu propio repositorio
</div>

Si omitiste conectar tu propio repositorio de Git durante la configuración inicial, tu documentación se encuentra en un repositorio privado propiedad de la organización de Doxa. Para moverla a tu propia cuenta u organización, ve a [Git Settings](https://dashboard.doxa.com/settings/deployment/git-settings) en tu dashboard. Un asistente de configuración te guía a través del proceso con dos opciones:
...
<AccordionGroup>
  <Accordion title="Clonar con un clic (recomendado)">
    ...
    4. Confirma la clonación. Doxa copia tus archivos de documentación en un nuevo repositorio.
    5. Opcionalmente, instala la Aplicación de GitHub de Doxa para despliegues automáticos.
  </Accordion>
  <Accordion title="Configuración manual">
    <Warning>
      Este proceso elimina permanentemente tu contenido del repositorio alojado en Doxa.
...
Instala la Aplicación de GitHub de Doxa desde tu [dashboard](https://dashboard.doxa.com/settings/organization/github-app).

<Frame>
  <img
    className="h-80"
    alt="Página de instalación de la Aplicación de GitHub de Doxa con la opción «Only select repositories» seleccionada."
...
Cambia la organización, el repositorio o la branch desde la que se compila tu documentación en la sección [Git Settings](https://dashboard.doxa.com/settings/deployment/git-settings) de tu dashboard.

<div id="github-enterprise-with-ip-allowlists">
  ## GitHub Enterprise con listas de IP permitidas
</div>

Si tu organización de GitHub Enterprise Cloud tiene habilitada una lista de IP permitidas, debes agregar la dirección IP saliente de Doxa (`54.242.90.151`) a tu lista para que la Aplicación de GitHub funcione correctamente.
...
<AccordionGroup>
  <Accordion title="Verificar la instalación de la Aplicación de GitHub">
    ...
    1. Ve a la [configuración de la Aplicación de GitHub](https://dashboard.doxa.com/settings/organization/github-app) en tu dashboard.
  ...
  <Accordion title="Comprobar la rama de implementación">
    ...
    1. Ve a [Git Settings](https://dashboard.doxa.com/settings/deployment/git-settings)
...
<Steps>
  <Step title="Desinstala la aplicación de Doxa desde GitHub.">
    1. En GitHub, ve a [installations](https://github.com/settings/installations) y selecciona **Configure** junto a la aplicación de Doxa. Desplázate hacia abajo y selecciona **Uninstall**.
    2. Ve a [Authorized GitHub Apps](https://github.com/settings/apps/authorizations) y selecciona **Revoke** junto a la aplicación de Doxa.
  </Step>
  <Step title="Reinstala la aplicación de Doxa.">
    1. En tu Dashboard de Doxa, ve a [Git Settings](https://dashboard.doxa.com/settings/deployment/git-settings) e instala la Aplicación de GitHub.
    2. Autoriza tu cuenta en la sección [My Profile](https://dashboard.doxa.com/settings/account) de tu dashboard.
  </Step>
</Steps>
...
<Steps>
  <Step title="Ir a Git Settings">
    Ve a [Git Settings](https://dashboard.doxa.com/settings/deployment/git-settings) en tu dashboard.
  </Step>
  <Step title="Volver a validar la configuración">
    ...
    <Frame>
      <img
        ...
        alt="La página de Git Settings en el Dashboard de Doxa. Una flecha naranja apunta a la marca de verificación verde que vuelve a validar la configuración del repositorio."
