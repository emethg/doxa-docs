...
Usa `mint export` para empaquetar todo tu sitio de documentación en un archivo zip autocontenido. Los destinatarios pueden descomprimirlo y ver la documentación en su navegador sin conexión a internet, sin una cuenta de Doxa ni herramientas de compilación—solo necesitan tener instalado [Node.js](https://nodejs.org).
