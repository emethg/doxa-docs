---
title: "¿Qué es Doxa?"
description: "Doxa es una plataforma de documentación diseñada para desarrolladores e IA, con búsqueda inteligente, playgrounds de API interactivos y analíticas integradas."
keywords: ["visión general", "cómo funciona", "arquitectura"]
---

Doxa aloja tu contenido como un sitio web. Tu contenido se almacena en un repositorio Git como archivos MDX, y Doxa construye y despliega tu sitio automáticamente cuando haces push de un cambio.

<div id="the-three-parts-of-a-doxa-project">
  ## Las tres partes de un proyecto de Doxa
</div>

**Tu repositorio** es la fuente de la verdad para tu documentación. Contiene un archivo MDX para cada página y un archivo `docs.json` que configura la navegación, el tema y los ajustes de tu sitio. Puedes usar tu propio repositorio de GitHub o GitLab, o dejar que Doxa cree uno para ti durante la configuración inicial.

**El Dashboard de Doxa** se conecta a tu repositorio y te permite gestionar tu sitio. Úsalo para supervisar las implementaciones, configurar los ajustes, gestionar a tu equipo y editar contenido directamente en el navegador.

**Tu sitio**, impulsado por Doxa. Doxa construye tu sitio a partir de tu repositorio y lo implementa en una URL `.doxa.app` de forma predeterminada. Cuando estés listo, puedes asignar un dominio personalizado a tu sitio.
