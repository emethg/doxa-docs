...
description: "Crea un workflow personalizado de Doxa con un trigger programado o de push, repositorios de contexto y un prompt para el agente para automatizar tareas de documentación recurrentes."
