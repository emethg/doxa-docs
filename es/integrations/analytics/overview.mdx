...
description: "Conecta tu documentación de Doxa a plataformas de análisis como Google Analytics, Mixpanel, PostHog y más para rastrear la interacción de los visitantes."
keywords: ["third-party analytics", "engagement tracking", "analytics platforms", "usage tracking"]
---

Realiza un seguimiento de cómo los usuarios interactúan con tu documentación conectando plataformas de Analytics de terceros. Doxa envía eventos de interacción a los proveedores de Analytics que hayas configurado.

<div id="how-analytics-integrations-work">
  ## Cómo funcionan las integraciones de Analytics
</div>

Cuando agregas integraciones de Analytics a tu sitio de documentación, Doxa registra interacciones de los usuarios como vistas de página, consultas de búsqueda, solicitudes en el área de pruebas de la API y envíos de comentarios, y las envía a tus proveedores de Analytics. Puedes conectar cualquier cantidad de proveedores de Analytics compatibles agregando tus claves de API al archivo `docs.json`. Los eventos de Analytics se envían a tus proveedores tan pronto como los agregas a tu configuración, sin necesidad de configuración adicional.
...
<CardGroup cols={2}>
  ...
  <Card
    title="Amplitude"
    href="/es/integrations/analytics/amplitude"
    horizontal
  ...
  <Card
    title="Clearbit"
    href="/es/integrations/analytics/clearbit"
    horizontal
    icon={
  ...
  <Card
    title="Fathom"
    href="/es/integrations/analytics/fathom"
    horizontal
    icon={
<svg
className="h-6 w-6"
...
/>
  ...
  <Card
    ...
    href="/es/integrations/analytics/google-analytics"
    horizontal
    icon={
      <svg
        className="h-6 w-6"
  ...
  <Card
    ...
    href="/es/integrations/analytics/google-tag-manager"
    horizontal
    icon={
      <svg
        className="h-6 w-6"
  ...
  <Card
    title="Heap"
    href="/es/integrations/analytics/heap"
    horizontal
    icon={
      <svg
        className="h-6 w-6"
  ...
  <Card
    title="Hightouch"
    href="/es/integrations/analytics/hightouch"
    horizontal
    icon={
      <svg
        className="h-6 w-6"
  ...
  <Card
    title="Hotjar"
    href="/es/integrations/analytics/hotjar"
    horizontal
    icon={
      <svg
        className="h-6 w-6"
  ...
  <Card
    title="LogRocket"
    href="/es/integrations/analytics/logrocket"
    horizontal
    icon={
      <svg
        className="h-7 w-5"
  ...
  <Card
    ...
    href="/es/integrations/analytics/clarity"
    horizontal
    icon={
  ...
  <Card
    title="Mixpanel"
    href="/es/integrations/analytics/mixpanel"
    horizontal
    icon={
      <svg
        className="h-6 w-6"
  ...
  <Card
    title="Pirsch"
    href="/es/integrations/analytics/pirsch"
    horizontal
    icon={
      <>
  ...
  <Card
    title="Plausible"
    href="/es/integrations/analytics/plausible"
    horizontal
    icon={
      <svg
        xmlns="http://www.w3.org/2000/svg"
  ...
  <Card
    title="PostHog"
    href="/es/integrations/analytics/posthog"
    horizontal
    icon={
      <svg
        className="h-6 w-6"
  ...
  <Card
    title="Segment"
    href="/es/integrations/analytics/segment"
    horizontal
    icon={
...
| `docs.footer.powered_by_doxa_click` | Cuando un usuario hace clic en el enlace &quot;Powered by Doxa&quot;.                                          |
