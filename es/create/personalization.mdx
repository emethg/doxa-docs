...
description: "Muestra contenido personalizado según los datos de autenticación del usuario, membresías de grupos y variables personalizadas para adaptar la documentación a cada audiencia."
...
El cierre de sesión se realiza en el cliente. Cuando los usuarios hacen clic en el botón de cerrar sesión, Doxa borra los datos de la sesión almacenados en el navegador.
