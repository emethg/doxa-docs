...
description: "Añade imágenes, inserta videos de YouTube e incluye iframes en tus páginas MDX para mejorar la documentación con contenido visual e interactivo."
...
<Frame>
  <img className="rounded-xl" src="https://doxa-assets.b-cdn.net/bigbend.jpg" alt="Fotografía de un paisaje con flores moradas en primer plano, montañas al fondo y un cielo azul con nubes dispersas." />
</Frame>
...
Los archivos SVG que usan elementos `foreignObject` se renderizan de forma diferente en producción que en el entorno de desarrollo local. La CDN de imágenes de Doxa elimina `foreignObject` de los SVG como medida de seguridad, lo que puede truncar u ocultar texto y otros contenidos HTML incrustados.
...
Doxa admite [etiquetas HTML en Markdown](https://www.markdownguide.org/basic-syntax/#html), lo que te brinda flexibilidad para crear contenido enriquecido.
