...
De forma predeterminada, Doxa genera los IDs de anclaje automáticamente a partir del texto del encabezado. Puedes sobreescribir el ID generado con uno personalizado usando la sintaxis `{#custom-id}`:
