...
description: "Crea fragmentos de contenido reutilizables con variables para mantener la coherencia entre páginas de documentación y reducir la duplicación en tus archivos MDX."
...
Crea un archivo con el contenido que quieras reutilizar. Los snippets pueden contener todos los tipos de contenido compatibles con Doxa y pueden importar otros snippets.
