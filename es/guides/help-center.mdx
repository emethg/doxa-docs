...
description: "Crea un centro de ayuda de autoservicio en Doxa que ayude a los clientes a encontrar respuestas, reduzca el volumen de tickets de soporte y escale con tu equipo."
...
Doxa proporciona la infraestructura para centros de soporte que escalan con tu base de clientes.
...
Esto crea un nuevo proyecto preconfigurado para un centro de ayuda, que incluye la estructura de navegación, páginas de ejemplo y listados de directorios. Consulta el [ejemplo en vivo](https://help-center-starter.doxa.app/) o revisa el [código fuente de la plantilla](https://github.com/doxa/templates/tree/main/help-center-starter).
...
Si aún no has creado un proyecto de Doxa, consulta la [Guía de inicio rápido](/es/quickstart) para desplegar tu sitio.

* Contenido para tus temas de soporte más habituales
* Acceso de administrador a tu organización de Doxa
...
* Exporta a **Markdown** para realizar la migración más sencilla a Doxa.
...
El assistant responde a las preguntas de los clientes utilizando tu contenido de soporte. Configúralo desde tu [dashboard](https://dashboard.doxa.com/products/assistant/settings).
...
<Steps>
  ...
  <Step title="Configura grupos de usuarios">
    Devuelve la información de grupos en los datos de tus usuarios para definir segmentos de clientes según el tipo de plan, el estado de la cuenta u otros atributos. Consulta [Formato de datos de usuario](/es/deploy/authentication-setup#user-data-format) para más detalles.
  </Step>
