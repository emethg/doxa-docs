...
description: "Aprende los fundamentos del control de versiones con Git para flujos de trabajo de documentación como código, incluyendo repositorios, branches, commits y colaboración mediante pull requests."
...
<Tabs>
  <Tab title="Usando el editor web">
    1. Abre el archivo en el [editor web](https://dashboard.doxa.com/editor).
