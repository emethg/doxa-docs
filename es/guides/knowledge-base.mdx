...
description: "Hospeda tu base de conocimientos interna en Doxa para consolidar la información de tu equipo, mejorar las búsquedas y reducir la carga de mantenimiento."
...
Doxa proporciona la infraestructura para bases de conocimientos a las que todo tu equipo puede contribuir.
...
Si aún no has creado un proyecto de Doxa, consulta la [Guía rápida](/es/quickstart) para publicar tu sitio.
...
* Exporta en **Markdown** para lograr la migración más sencilla a Doxa. (recomendado)
...
Configura el assistant desde tu [dashboard](https://dashboard.doxa.com/products/assistant/settings):
...
Una base de conocimientos se mantiene precisa cuando todos pueden actualizarla, no solo las personas que la configuraron. Doxa ofrece tres formas para que los miembros del equipo contribuyan rápidamente a tu base de conocimientos.
