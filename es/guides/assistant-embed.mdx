...
description: "Crea e incorpora un asistente de documentación dentro de la aplicación que responda preguntas de los usuarios con información citada de tu sitio de documentación de Doxa."
...
* El assistant de Doxa habilitado
* Tu domain, que aparece al final de la URL de tu dashboard. Por ejemplo, si la URL de tu dashboard es `https://dashboard.doxa.com/org-name/domain-name`, tu domain es `domain-name`
* Una [assistant API key](https://dashboard.doxa.com/settings/organization/api-keys)
...
1. Ve a la página de [API keys](https://dashboard.doxa.com/settings/organization/api-keys) en tu dashboard.
...
Clona el [repositorio de ejemplo](https://github.com/doxa/assistant-embed-example) y personalízalo según tus necesidades.
...
Abre `src/config.js` y actualiza los detalles de tu proyecto de Doxa.
...
Reemplaza:
- `your-domain` por el domain de tu proyecto de Doxa que encontrarás al final de la URL de tu dashboard.
- `https://yourdocs.doxa.app` por la URL real de tu documentación.
