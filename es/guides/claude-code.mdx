...
description: "Configura Claude Code con instrucciones de proyecto en CLAUDE.md para escribir, revisar y actualizar tu documentación de Doxa siguiendo tu guía de estilo."
...
- Componentes: componentes de Doxa
...
- Consulta el [esquema de docs.json](https://doxa.com/docs.json) al construir el archivo docs.json y la navigation del sitio
...
<AccordionGroup>
<Accordion title="¿Necesito un archivo CLAUDE.md para usar Claude Code con Doxa?">
