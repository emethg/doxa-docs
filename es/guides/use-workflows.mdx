...
description: "Aprende a usar los workflows de Doxa para automatizar tareas recurrentes de mantenimiento de contenido, elige el tipo de trigger adecuado, escribe instrucciones efectivas y obtén resultados consistentes."
...
Para tareas puntuales o exploratorias, usa el agente directamente en el [panel](https://app.doxa.com) o desde Slack.
...
Doxa incluye workflows predefinidos para las tareas más comunes de mantenimiento de contenido. Activa cualquiera de ellos desde la página [Workflows](https://app.doxa.com/products/workflows?tab=workflows) de tu panel.
...
- El prompt del workflow se refiera a archivos fuera del repositorio de tu proyecto de Doxa.
...
- **Automático**: Los cambios se mergean directamente en el repositorio de tu proyecto de Doxa sin revisión. Mejor para tareas de bajo riesgo y alta frecuencia como traducción, verificaciones gramaticales y reparación de enlaces.
...
1. Abre la pestaña **Runs** en la página [Workflows](https://app.doxa.com/products/workflows) para ver el historial de ejecuciones recientes y su estado.
