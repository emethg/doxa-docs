...
description: "Crea documentación para desarrolladores que ayude a los ingenieros a integrarse con tus APIs, SDKs y herramientas, incluyendo guías de inicio rápido, referencias y guías."
...
Doxa proporciona infraestructura diseñada para la documentación para desarrolladores.
...
* **Bloques de código con explicaciones**: El [assistant](/es/assistant/index) explica ejemplos de código en contexto, ayudando a los desarrolladores a entender los detalles de implementación.
...
* Exporta a **Markdown** para la migración más sencilla a Doxa.
...
El assistant ayuda a los desarrolladores a encontrar respuestas y comprender ejemplos de código. Configúralo desde tu [dashboard](https://dashboard.doxa.com/products/assistant/settings).
...
Instala la [Aplicación de GitHub](/es/deploy/github) de Doxa para mantener la documentación sincronizada con tu base de código y permitir contribuciones.

<Steps>
  <Step title="Connect your repository">
    Vincula tu repositorio de GitHub en el [dashboard](https://dashboard.doxa.com). Esto habilita implementaciones automáticas cuando haces push de cambios.
  </Step>
