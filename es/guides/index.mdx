---
title: "Guías"
description: "Explora guías sobre mejores prácticas de documentación, estrategia de contenido, optimización SEO, accesibilidad y flujos de trabajo de docs-as-code para tu equipo."
boost: 3
---
...
* [Configurar automerge](/es/guides/configure-automerge): Agrega la aplicación GitHub de Doxa a la lista de bypass de un ruleset para habilitar la fusión automática de flujos de trabajo.
* [Usar workflows](/es/guides/use-workflows): Elige el trigger de workflow adecuado, escribe instrucciones efectivas y obtén resultados consistentes del mantenimiento automatizado de contenido.
...
Entiende Git para sacar el máximo partido de Doxa y de un enfoque de documentación como código (docs-as-code).
...
Descubre cómo Doxa se adapta a distintos casos de uso y encuentra la solución que mejor funcione para ti.

* [Crear documentación para desarrolladores](/es/guides/developer-documentation): Ayuda a tus usuarios a sacar el máximo partido de tu producto o API con documentación para desarrolladores que responda preguntas y les permita volver rápidamente a sus tareas principales.
...
* [Crear un frontend personalizado](/es/guides/custom-frontend): Usa la integración de Doxa con Astro para mostrar tu documentación con un frontend totalmente personalizado.
