---
title: "Escribe documentación con Windsurf"
sidebarTitle: "Windsurf"
description: "Configura Windsurf Cascade con workspace rules y memorias para redactar documentación de Doxa que siga tu guía de estilo y los estándares de MDX."
keywords: ["Windsurf", "Cascade", "workspace rules", "documentación con IA", "documentación con Windsurf"]
---

Convierte Windsurf en un experto en documentación que comprenda tu guía de estilo, tus componentes y el contexto de tu proyecto mediante workspace rules y memories.

<div id="use-windsurf-with-doxa">
  ## Usa Windsurf con Doxa
</div>

El assistant Cascade de IA de Windsurf se puede ajustar para redactar documentación conforme a tus estándares utilizando componentes de Doxa. Las reglas del espacio de trabajo y las memorias proporcionan contexto persistente sobre tu proyecto, lo que garantiza sugerencias más consistentes de Cascade.
...
Esta regla proporciona a Cascade contexto sobre los componentes de Doxa y las mejores prácticas generales de documentación técnica.
...
````mdx
# Regla de redacción técnica de Doxa

## Contexto del proyecto

- Este es un proyecto de documentación en la plataforma Doxa
...
- Consulta el [esquema de docs.json](https://doxa.com/docs.json) al construir el archivo docs.json y la navegación del sitio
...
Conecta el servidor MCP de Doxa a Windsurf para que Cascade pueda buscar en la documentación de Doxa mientras escribes. Cuando conectas el servidor MCP, Cascade busca en la documentación más reciente de Doxa para obtener contexto, de modo que no tengas que salir de tu IDE para consultar la documentación.

Consulta [Model Context Protocol](/es/ai/model-context-protocol#example%3A-connect-to-the-doxa-mcp-server) para ver las instrucciones completas de configuración.