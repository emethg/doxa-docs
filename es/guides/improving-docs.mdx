...
Las analíticas de Doxa te permiten ver las puntuaciones de comentarios junto con los datos de tráfico. Usa esto para priorizar:
...
<Tip>
  Usa [flujos de trabajo](/workflows) para automatizar mejoras recurrentes, como abrir un pull request con correcciones sugeridas para páginas marcadas por puntuaciones de comentarios bajas.
</Tip>
