...
En la documentación de Doxa, el H1 de la página se genera automáticamente a partir de la propiedad `title:` del frontmatter. No agregues un H1 manual en el cuerpo.
...
<Tip>
  Usa un [workflow](/workflows) para ejecutar una auditoría de estilo de forma programada o cada vez que se envíen cambios a tu repositorio de documentación.
</Tip>
