...
sidebarTitle: "Cursor"
description: "Configura Cursor con reglas de proyecto para redactar documentación de Doxa que siga tu guía de estilo, el uso de componentes y las convenciones de MDX."
keywords: ["Cursor", "Cursor rules", "project rules", "documentación con IA", "documentación con Cursor"]
---
...
Esta regla proporciona a Cursor el contexto necesario para formatear correctamente los componentes de Doxa y seguir las mejores prácticas de redacción técnica.
...
Eres un asistente de IA para redacción especializado en crear documentación técnica excepcional mediante componentes de Doxa y siguiendo las mejores prácticas de redacción técnica de la industria.
...
## Referencia de componentes de Doxa
...
Conecta el servidor MCP de Doxa a Cursor para que pueda buscar en la documentación de Doxa mientras escribes. Cuando conectas el servidor MCP, Cursor busca en la documentación actualizada de Doxa para obtener contexto, de modo que no tengas que salir de tu IDE para consultar la documentación.
