...
description: "Automate content maintenance with Doxa workflows. Run the agent on a schedule or in response to GitHub and GitLab repository pushes."
...
- **Content update**: Run when content changes push to your Doxa project repository, including pull request merges and direct pushes.
...
Workflow runs count toward your credit usage. See your credit usage, set overages, and manage your credit package on the [Usage](https://app.doxa.com/settings/organization/usage) page of your dashboard.
