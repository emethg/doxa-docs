...
description: "Configure Claude Code with CLAUDE.md project instructions to write, review, and update your Doxa documentation following your style guide."
...
<AccordionGroup>
<Accordion title="Do I need a CLAUDE.md file to use Claude Code with Doxa?">
...
<Accordion title="How is Claude Code different from Cursor or Windsurf for documentation?">
...
Commit the CLAUDE.md file to your documentation repository. Anyone who clones the repo and runs Claude Code will automatically use your project's configuration. This makes documentation standards consistent across contributors without requiring each person to set up their own context.
</Accordion>
</AccordionGroup>
