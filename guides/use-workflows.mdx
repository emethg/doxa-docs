---
title: "Use workflows"
description: "Use Doxa workflows to automate recurring docs maintenance: choose the right trigger, write effective instructions, and get consistent agent results."
...
For one-off or exploratory tasks, use the agent directly in the [dashboard](https://app.doxa.com) or from Slack.
...
Doxa includes predefined workflows for the most common content maintenance tasks. Toggle any of them on from the [Workflows](https://app.doxa.com/products/workflows?tab=workflows) page of your dashboard.
...
- The workflow prompt refers to files outside your Doxa project repository.
...
- **Automatic**: Changes merge directly into your Doxa project repository without review. Best for low-risk, high-frequency tasks like translation, grammar checks, and link fixes.
...
1. Open the **Runs** tab on the [Workflows](https://app.doxa.com/products/workflows) page to see recent run history and status.
