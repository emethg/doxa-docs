---
title: "How to set up multi-language documentation"
...
keywords: ["internationalization", "i18n", "multi-language documentation", "translations", "localization", "language switcher"]
---
...
If you work with your own translation vendors or regional translators, you can integrate their workflow with your Doxa documentation using GitHub Actions or similar CI/CD tools.
...
Yes. Navigation labels—group names, tab titles, anchor text—should match the language of the content. An English "Getting started" label in a Spanish documentation section creates a jarring experience. Doxa supports language-specific navigation structures, so each language can have fully translated labels.
</Accordion>
