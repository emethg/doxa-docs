...
Doxa provides infrastructure built for developer documentation.
...
The assistant helps developers find answers and understand code examples. Configure it from your [dashboard](https://app.doxa.com/products/assistant/settings).
...
Install the Doxa [GitHub App](/deploy/github) to keep documentation in sync with your codebase and enable contributions.

<Steps>
  <Step title="Connect your repository">
    Link your GitHub repository in the [dashboard](https://app.doxa.com). This enables automatic deployments when you push changes.
  </Step>
