...
description: "Build a self-service help center on Doxa that helps customers find answers, reduces support ticket volume, and scales with your team."
...
Doxa provides infrastructure for help centers that scale with your customer base.
...
This creates a new project pre-configured for a help center, including navigation structure, sample pages, and directory listings. See the [live example](https://help-center-starter.doxa.app/) or browse the [template source](https://github.com/doxa/templates/tree/main/help-center-starter).
...
- Export to **Markdown** for the simplest migration to Doxa.
...
The assistant answers customer questions using your support content. Configure it from your [dashboard](https://app.doxa.com/products/assistant/settings).
