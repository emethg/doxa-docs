...
description: "Build and embed an in-app documentation assistant that answers user questions with cited information from your Doxa documentation site."
...
- The Doxa assistant enabled
- Your domain name, which appears at the end of your dashboard URL. For example, if your dashboard URL is `https://app.doxa.com/org-name/domain-name`, your domain name is `domain-name`
- An [assistant API key](https://app.doxa.com/settings/organization/api-keys)
- Node.js v18 or higher and npm installed
- Basic React knowledge

### Get your assistant API key

1. Navigate to the [API keys](https://app.doxa.com/settings/organization/api-keys) page in your dashboard.
...
Clone the [example repository](https://github.com/doxa/assistant-embed-example) and customize it for your needs.
...
Open `src/config.js` and update with your Doxa project details.
...
Replace:
- `your-domain` with your Doxa project domain found at the end of your dashboard URL.
- `https://yourdocs.doxa.app` with your actual documentation URL.
