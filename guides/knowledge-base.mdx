...
description: "Host your internal knowledge base on Doxa to consolidate information for your team, improve search, and reduce maintenance burden."
...
Doxa provides the infrastructure for knowledge bases that your entire team can contribute to.
...
If you haven't created a Doxa project yet, see the [Quickstart](/quickstart) to deploy your site.

- An authentication system (SSO or OAuth provider like Okta or Azure AD)
- Control over your domain for hosting
- Admin access to your Doxa organization
...
- Export to **Markdown** for the simplest migration to Doxa. (recommended)
...
Configure the assistant from your [dashboard](https://app.doxa.com/products/assistant/settings):
...
A knowledge base stays accurate when everyone can update it, not just the people who set it up. Doxa provides three ways for team members to contribute quickly to your knowledge base.
...
When someone shares useful information in a Slack thread, any team member can mention `@doxa` with instructions to document it. The agent reads the conversation, extracts the relevant information, and creates a pull request. This is useful for capturing technical decisions, troubleshooting solutions, and process explanations while the context is still fresh.

For example, if your team discussed how to configure a new integration in a thread, you could reply:

> @doxa Create a guide for configuring the Acme integration based on this conversation.
