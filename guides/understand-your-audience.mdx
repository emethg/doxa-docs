...
Identify the primary audience for each page rather than trying to serve everyone in the same content. For products with genuinely distinct audiences—separate personas with different goals and knowledge levels—consider whether separate documentation sections or navigation paths make sense. Doxa supports tab-based navigation that can separate content by audience without requiring entirely separate documentation sites.
</Accordion>
