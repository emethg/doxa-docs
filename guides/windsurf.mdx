---
title: "Write documentation with Windsurf"
sidebarTitle: "Windsurf"
description: "Configure Windsurf Cascade with workspace rules and memories to write Doxa documentation that follows your style guide and MDX standards."
keywords: ["Windsurf", "Cascade", "workspace rules", "AI documentation", "Windsurf documentation"]
---
...
## Use Windsurf with Doxa

Windsurf's Cascade AI assistant can be tuned to write documentation according to your standards using Doxa components. Workspace rules and memories provide persistent context about your project, ensuring more consistent suggestions from Cascade.
...
This rule provides Cascade with context about Doxa components and general technical writing best practices.
...
````mdx
# Doxa technical writing rule

## Project context

- This is a documentation project on the Doxa platform
...
- Refer to the [docs.json schema](https://doxa.com/docs.json) when building the docs.json file and site navigation
...
Connect the Doxa MCP server to Windsurf to give Cascade access to search the Doxa documentation while helping you write. When you connect the MCP server, Cascade searches the up to date Doxa documentation for context so you don't have to leave your IDE to reference documentation.

See [Model Context Protocol](/ai/model-context-protocol#example%3A-connect-to-the-doxa-mcp-server) for complete setup instructions.