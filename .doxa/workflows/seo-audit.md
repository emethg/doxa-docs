...
- Titles that follow a boilerplate pattern like "PageType - Doxa" without describing the specific content of the page
...
When writing titles: be descriptive and specific about what the page covers. Avoid generic patterns like "Overview - Doxa". Target 50-60 characters.
