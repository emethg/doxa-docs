...
1. Go to the [Agent integrations](https://app.doxa.com/settings/organization/integrations) page in your dashboard.
2. Find the integration you want to connect.
3. Click **Connect**.
4. Follow the OAuth prompts to authorize Doxa to access your account.
