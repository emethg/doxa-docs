...
Your Pro plan includes migration services to transfer your documentation to Doxa. This guide covers the migration process, delivery timelines, and our quality assurance approach.
...
<Steps>
  <Step title="Submit the migration form">
    Submit the [migration form](https://doxa.typeform.com/pro-migrations).
...
1. [Connect your GitHub repository and get setup](https://www.doxa.com/docs/quickstart#install-the-github-app).
2. [Set up redirects if required](https://www.doxa.com/docs/create/redirects).
3. [Configure your custom domain](https://www.doxa.com/docs/customize/custom-domain).
...
<Note>
  **Need help?** Our support team is available to guide you through these steps. Reach out via [support@doxa.com](mailto:support@doxa.com).
</Note>
