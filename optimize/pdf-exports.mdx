...
<Info>
  PDF exports are available on [Enterprise plans](https://doxa.com/pricing).
</Info>
...
<Tip>
  To let users download individual pages as PDFs, use the [contextual menu's](/ai/contextual-menu) `download-pdf` option instead.
</Tip>

## Export a PDF

1. Navigate to the [General](https://app.doxa.com/settings/deployment/general) page in the Project Settings section of your dashboard.
