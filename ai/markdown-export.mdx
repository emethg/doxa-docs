...
Doxa automatically generates Markdown versions of pages optimized for AI tools and external integrations.

## .md URL extension

Add `.md` to any page's URL to view a Markdown version.

<PreviewButton href="https://doxa.com/docs/ai/markdown-export.md">Open this page as Markdown</PreviewButton>
...
If you enable [agent feedback](/optimize/feedback#agent-feedback), Doxa appends an `<AgentInstructions>` block to each page's Markdown export that tells agents how to submit feedback about the page's content.
