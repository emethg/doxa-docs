...
| **Download PDF** | `download-pdf` | Downloads the current page as a PDF. Available on [Enterprise plans](https://doxa.com/pricing). |
    ...
    <ResponseField name="query" type="object" required>
      ...
      <Expandable title="query object">
        ...
        <ResponseField name="value" type="string" required>
          The query parameter value. Doxa replaces the following placeholders with the corresponding values:
