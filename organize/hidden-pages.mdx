...
<Note>
  ...
  To include it anyway, set `seo.indexing: "all"` in `docs.json`. See [Search, SEO, and AI indexing](https://www.doxa.com/docs/#search-seo-and-ai-indexing) for details.

  Note: `noindex: true` only affects indexing - it does not hide the page from navigation. See [Disable indexing](https://www.doxa.com/docs/optimize/seo#disable-indexing) for more information.
</Note>
