---
title: "Integrations"
description: "Connect analytics platforms, chat widgets, and third-party services to your Doxa documentation site through the docs.json integrations config."
...
<ResponseField name="integrations.telemetry" type="object">
  Doxa telemetry settings.

  <Expandable title="integrations.telemetry">
    <ResponseField name="enabled" type="boolean">
      Whether to enable Doxa telemetry. When set to `false`, feedback features are also disabled and do not appear on your documentation pages.
    </ResponseField>
  </Expandable>
</ResponseField>
