...
When Doxa builds your documentation, it reads the `.mintignore` file and excludes any matching files or directories from processing.
...
Doxa automatically ignores the following directories and files without requiring any configuration:
