...
description: "将 Google Analytics 4 集成到你的 Doxa 文档，通过 GA4 ID 跟踪访客行为、页面浏览量和内容参与情况。"
keywords: ["GA4 integration", "measurement ID", "web stream", "Universal Analytics"]
---

你需要创建一个新的<Tooltip tip="Google Analytics 4">GA4</Tooltip>资源以供 Doxa 使用。收集的数据归入与你其他 Google Analytics 数据相同的项目。
...
你需要创建一个 Web 流以获取 Measurement ID，并将其填入 Doxa。
...
创建一个 Web 流，并将你的 Doxa 文档站点的 URL 作为流的 URL。
