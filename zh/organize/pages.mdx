...
<ResponseField name="title" type="string">
  ...
  如果省略，Doxa 会根据路径生成标题。路径的最后一段会作为标题，其中的短横线和下划线会被替换为空格，且首字母会大写。例如，`guides/getting-started.md` 会变为 **入门**。
</ResponseField>
...
Doxa 会自动生成大多数 SEO (搜索引擎优化) 元标签。你也可以手动设置 SEO 元标签，以自定义 SEO、社交分享和浏览器兼容性相关的配置。
