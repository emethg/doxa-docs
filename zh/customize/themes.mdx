...
<div className="pt-10 pb-24 px-4 max-w-3xl mx-auto prose prose-gray">
  ...
  <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-8 not-prose">
    <ThemeCard title="Mint" value="mint" description="经典文档主题，布局经过时间检验，导航直观易用。" href="https://mint.doxa.app" />

    <ThemeCard title="Maple" value="maple" description="现代、清爽的审美风格，完美适配 AI 与 SaaS 产品。" href="https://maple.doxa.app" />

    <ThemeCard title="Palm" value="palm" description="精致的金融科技主题，为企业级文档提供深度自定义能力。" href="https://palm.doxa.app" />

    <ThemeCard title="Willow" value="willow" description="回归本质的极简配置，带来无干扰的阅读体验。" href="https://willow.doxa.app" />

    <ThemeCard title="Linden" value="linden" description="复古终端氛围与等宽字体，呈现 80 年代的黑客美学。" href="https://linden.doxa.app" />

    <ThemeCard title="Almond" value="almond" description="卡片式信息组织结合极简设计，带来直观的导航。" href="https://almond.doxa.app" />

    <ThemeCard title="Aspen" value="aspen" description="为复杂导航与自定义组件打造的现代文档主题。" href="https://aspen.doxa.app" />

    <ThemeCard title="Sequoia" value="sequoia" description="极简优雅的布局，专为大规模、以内容为核心的文档设计。" href="https://sequoia.doxa.app" />

    <ThemeCard title="Luma" value="luma" description="干净、极简的设计，为精致的文档体验而生。" href="https://luma.doxa.app" />
  </div>
</div>
