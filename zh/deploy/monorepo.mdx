---
title: "Monorepo 设置"
description: "在 monorepo 项目中配置文档路径和内容目录，使 Doxa 仅从你指定的文档文件夹部署。"
keywords: ["monorepo", "content 目录", "多项目存储库"]
---

将 Doxa 配置为从 monorepo 中的指定目录部署文档。此设置可让你在包含多个项目或服务的存储库中，将文档与代码一同维护。
...
在你的控制台前往 [Git Settings](https://dashboard.doxa.com/settings/deployment/git-settings)。
