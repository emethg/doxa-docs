---
title: "Cloudflare"
description: "通过 Cloudflare Workers 将你的 Doxa 文档部署到域名的子路径，包含分步设置和 DNS 配置说明。"
...
在部署代码后，测试你的 Worker，确保它正确路由到你的 Doxa 文档。

1. 使用 Worker 的预览 URL 进行测试：`your-worker.your-subdomain.workers.dev/docs`
2. 确认该 Worker 能正确路由到你的 Doxa 文档和你的网站。
...
如果你使用 Webflow 托管主站点，并希望在同一 domain 的 `/docs` 路径下提供 Doxa 文档，你需要通过 Cloudflare Workers 配置自定义路由，将所有非 docs 流量代理到你的主站点。
