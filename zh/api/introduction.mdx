---
title: "简介"
description: "使用 Doxa REST API 触发部署、嵌入 AI 助手、导出 Analytics 数据，并以编程方式管理文档。"
keywords: ["REST API", "endpoints", "API keys"]
boost: 3
---

Doxa 的 REST（Representational State Transfer）API 让你可以以编程方式与文档交互、触发更新、嵌入 AI 驱动的聊天体验，并导出 Analytics 数据。
...
在控制台的 [API keys 页面](https://dashboard.doxa.com/settings/organization/api-keys)生成 API key。每个 API key 都属于一个组织，你可以在同一组织内的多个部署中使用这些 API key。
