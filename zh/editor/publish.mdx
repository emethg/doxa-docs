...
<Tip>
  当你从编辑器创建拉取请求时，Doxa agent 会根据你的更改自动生成标题和描述。你可以在创建拉取请求之前编辑生成的标题和描述。
</Tip>
...
<img src="/images/editor/toolbar-branch-light.png" alt="网页编辑器工具栏，显示一个待处理的更改，以及功能分支上的 Save in branch 按钮。" className="block dark:hidden" />
<img src="/images/editor/toolbar-branch-dark.png" alt="网页编辑器工具栏，显示一个待处理的更改，以及功能分支上的 Save in branch 按钮。" className="hidden dark:block" />
</Frame>
...
<Note>
  Doxa 构建并部署你已发布的更改后，你的线上文档站点会更新。这通常需要 30 秒到几分钟。你可以在你的 [dashboard](https://dashboard.doxa.com) 上查看更改的部署状态。
</Note>
...
在你的 [账户设置](https://dashboard.doxa.com/settings/account) 中授权你的 GitHub 账号，即可用该账号对提交进行签名。若未完成授权，则由 Doxa GitHub 应用为在网页编辑器中完成的提交进行签名。
