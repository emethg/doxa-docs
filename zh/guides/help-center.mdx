...
这会创建一个为支持中心预先配置好的新项目，包含导航结构、示例页面和目录列表。查看[在线示例](https://help-center-starter.doxa.app/)或浏览[模板源代码](https://github.com/doxa/templates/tree/main/help-center-starter)。
...
如果你还没有创建 Doxa 项目，请先查看[快速开始](/zh/quickstart) 来部署你的网站。
...
* 将内容导出为 **Markdown**，以最简单的方式迁移到 Doxa。
...
AI 助手会基于你的支持内容回答客户问题。你可以在[控制台](https://dashboard.doxa.com/products/assistant/settings)中进行配置。
