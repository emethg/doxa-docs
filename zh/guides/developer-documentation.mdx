...
如果尚未创建 Doxa 项目，请参阅[快速开始](/zh/quickstart)以部署你的文档站点。
...
AI 助手可以帮助开发者找到答案并理解代码示例。你可以在 [控制台](https://dashboard.doxa.com/products/assistant/settings) 中进行配置。
...
安装 Doxa [GitHub 应用](/zh/deploy/github)，使文档与你的代码库保持同步，并支持协作贡献。

<Steps>
  <Step title="连接你的存储库">
    在[控制台](https://dashboard.doxa.com)中链接你的 GitHub 存储库。在你推送更改时，这将启用自动部署。
  </Step>
