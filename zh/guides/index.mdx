---
title: "指南"
description: "浏览文档最佳实践、内容策略、SEO 优化、可访问性和 docs-as-code 工作流程的实用指南。"
boost: 3
---
...
* [配置自动合并](/zh/guides/configure-automerge)：将 Doxa GitHub 应用添加到规则集的绕过列表中，以启用工作流程的自动合并。
...
* [Custom page layouts](/zh/guides/custom-layouts)：使用页面模式和组件构建落地页和其他自定义布局。
...
了解 Git，以便在 Doxa 中以及采用文档即代码 (docs-as-code) 的方法时发挥最大效用。
...
了解 Doxa 如何满足不同的使用需求，并找到适合你的解决方案。
...
* [创建帮助中心](/zh/guides/help-center)：搭建自助式帮助中心，让用户能够自主找到答案，减少工单数量，并提升客户满意度。
* [创建自定义前端](/zh/guides/custom-frontend)：使用 Doxa 的 Astro 集成，通过完全自定义的前端来渲染你的文档。
