...
Doxa 会自动生成针对 AI 工具和外部 integrations 优化的页面 Markdown 版本。
...
<PreviewButton href="https://doxa.com/docs/ai/markdown-export.md">以 Markdown 打开此页面</PreviewButton>
...
如果你启用了 [Agent 反馈](/zh/optimize/feedback#agent-feedback)，Doxa 会在每个页面的 Markdown 导出中附加一个 `<AgentInstructions>` 块，告知 Agent 如何提交关于页面内容的反馈。
