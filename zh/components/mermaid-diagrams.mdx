---
title: "Mermaid"
description: "使用 Mermaid 语法在文档中创建流程图、序列图和其他可视化图表，并自动渲染。"
...
Doxa 支持将 [ELK（Eclipse Layout Kernel）](https://www.eclipse.org/elk/) 布局引擎用于 Mermaid 图表。ELK 会优化元素排布，减少重叠并提升可读性，对大型或复杂图表尤其有用。
