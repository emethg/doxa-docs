---
title: "概览"
description: "浏览 Doxa 完整组件库，包含适用于 MDX 页面的布局、强调、API 文档和导航元素组件。"
keywords:
  ["MDX 组件", "文档组件", "UI 组件", "组件"]
boost: 3
---

Doxa 为你的文档页面提供了内置的 MDX 组件。使用这些组件来组织内容、突出重要信息、编写 API 文档，并引导读者在文档中导航。
...
<Card title="Prompt" icon="sparkles" href="/zh/components/prompt">
...
<Card title="Tree" icon="folder-tree" href="/zh/components/tree">
  展示文件和文件夹的层级结构。
</Card>