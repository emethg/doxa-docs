---
title: "Doxa CLI"
description: "Use the Doxa CLI to preview docs locally, test changes in real time, analyze site performance, and run quality checks before deploying."
...
The CLI runs on your machine and connects to your Doxa deployment when you need live data.
...
<Tip>
  Working on your docs locally with an AI coding tool? Install the Doxa [skill](/ai/skillmd) and [MCP server](/ai/model-context-protocol) so your editor has the context it needs to write Doxa-aware content.
</Tip>
