...
<Info>
  Audit logs are available on [Enterprise plans](https://doxa.com/pricing?ref=audit-logs).
</Info>
...
Go to the [Audit log](https://app.doxa.com/settings/organization/audit-logs) page of your dashboard to view audit logs.
...
1. Navigate to the [Audit log](https://app.doxa.com/settings/organization/audit-logs) page of your dashboard.
1. Optionally, apply filters to narrow down the logs you want to export.
1. Click **Export CSV**.
1. Doxa sends you an email with a download link when the export is ready.
