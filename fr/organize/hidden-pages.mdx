...
<Note>
  ...
  Pour l’inclure malgré tout, définissez `seo.indexing: "all"` dans `docs.json`. Consultez [Recherche, SEO et indexation IA](https://www.doxa.com/docs/#search-seo-and-ai-indexing) pour plus de détails.

  Remarque : `noindex: true` n’affecte que l’indexation — cela ne masque pas la page de la navigation. Consultez [Désactiver l’indexation](https://www.doxa.com/docs/optimize/seo#disable-indexing) pour plus d’informations.
</Note>
