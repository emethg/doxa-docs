...
description: "Explorez les cas d’usage des pages cachées : documentation bêta, fichiers de contexte IA, archives de contenu hérité et références d’outils internes dans Doxa."
---
