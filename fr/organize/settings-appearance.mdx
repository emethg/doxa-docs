...
description: "Configurez le thème, les couleurs, le logo, le favicon, les polices et l'arrière-plan dans docs.json pour votre site de documentation."
...
<ResponseField name="styling.latex" type="boolean">
  Contrôle si les feuilles de style LaTeX se chargent. Par défaut, Doxa détecte automatiquement l'utilisation de LaTeX dans votre contenu et charge les feuilles de style nécessaires.
