---
title: "Intégrations"
description: "Connectez des plateformes d'analyse, des widgets de chat et des services tiers à votre site de documentation Doxa via la configuration des intégrations dans docs.json."
...
<ResponseField name="integrations.telemetry" type="object">
  Paramètres de télémétrie Doxa.

  <Expandable title="integrations.telemetry">
    <ResponseField name="enabled" type="boolean">
      Indique s'il faut activer la télémétrie Doxa. Lorsque défini sur `false`, les fonctionnalités de feedback sont également désactivées et n'apparaissent pas sur les pages de votre documentation.
    </ResponseField>
  </Expandable>
</ResponseField>
