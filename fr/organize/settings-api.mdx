...
<ResponseField name="api.params" type="object">
  ...
  <Expandable title="api.params">
    ...
    <ResponseField name="post" type="array of string">
      Clés de champs de la spécification OpenAPI à faire apparaître sous forme de pastilles post à côté du nom de chaque paramètre dans les pages de référence d'API et dans le playground. Pour chaque clé que vous listez, Doxa lit la valeur depuis le schéma et l'affiche sous forme de pastille :
