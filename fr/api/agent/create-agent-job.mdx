...
<Warning>Cet endpoint est obsolète. Utilisez plutôt l’endpoint [v2 create agent job](/fr/api/agent/v2/create-agent-job).</Warning>
...
* 100 utilisations par projet Doxa et par heure
