...
description: "Créez un workflow Doxa personnalisé avec un trigger planifié ou de type push, des dépôts de contexte et un prompt pour l'agent afin d'automatiser les tâches récurrentes de documentation."
