---
title: "Hightouch"
description: "Intégrez Hightouch à votre documentation Doxa pour synchroniser les données d’analyse et faciliter l’activation d’audiences, la segmentation et le routage vers des outils en aval."
