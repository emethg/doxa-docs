...
description: "Affichez du contenu personnalisé selon l'authentification, l'appartenance aux groupes et des variables personnalisées pour adapter la doc à chaque audience."
...
La déconnexion s&#39;effectue côté client. Lorsque les utilisateurs cliquent sur le bouton de déconnexion, Doxa efface les données de session stockées dans le navigateur.
