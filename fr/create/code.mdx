...
description: "Formatez le code dans votre documentation avec coloration syntaxique, numéros de ligne, diffs, boutons de copie et fonctionnalités interactives de groupes de code en MDX."
