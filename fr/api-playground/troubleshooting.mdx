---
title: "Dépannage"
description: "Résolvez les problèmes courants de configuration du playground API, notamment les erreurs de validation OpenAPI, les endpoints manquants et les problèmes d'authentification."
...
<AccordionGroup>
  <Accordion title="Toutes mes pages OpenAPI sont complètement vides">
    Dans ce scénario, il est probable que Doxa ne trouve pas votre document OpenAPI
    ...
    C’est exactement le paquet de validation que Doxa utilise pour valider les documents OpenAPI ; si votre document
    est validé ici, il y a de fortes chances que le problème se situe ailleurs.

    Par ailleurs, Doxa ne prend pas en charge OpenAPI 2.0. Si votre document utilise cette version de la spécification,
  ...
  <Accordion title="L’une de mes pages OpenAPI s’affiche complètement vide">
    ...
    <Note>
      Doxa résout automatiquement les différences de barre oblique finale entre votre référence `openapi`
