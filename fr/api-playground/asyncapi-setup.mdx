...
<Note>
  Le champ `directory` est facultatif. S’il n’est pas indiqué, Doxa ajoute les fichiers dans le dossier **api-reference** du dépôt de documentation.
</Note>

### Exemples avec des groupes imbriqués

La propriété `asyncapi` prend en charge les groupes imbriqués. Doxa génère les pages de canaux et les ajoute au groupe imbriqué, aux côtés des pages existantes.
