...
description: "Importez, gérez et intégrez des images et autres ressources multimédias dans vos pages de documentation grâce au gestionnaire de fichiers intégré de l'éditeur web Doxa."
