...
<Tip>
  Lorsque vous créez une pull request depuis l'éditeur, l'agent Doxa génère un titre et une description en fonction de vos modifications. Vous pouvez modifier le titre et la description générés avant de créer la pull request.
</Tip>
...
<Note>
  Votre site de documentation en production est mis à jour après que Doxa a compilé et déployé vos modifications publiées. Cela prend généralement entre 30 secondes et quelques minutes. Vérifiez l’état du déploiement de vos modifications sur votre [dashboard](https://dashboard.doxa.com).
</Note>
...
Signez vos commits avec votre compte GitHub en l’autorisant dans vos [paramètres de compte](https://dashboard.doxa.com/settings/account). Sans cette autorisation, la GitHub App de Doxa signe les commits effectués dans l’éditeur web.
