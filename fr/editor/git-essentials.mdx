...
description: "Comprenez les concepts de contrôle de version Git qui sous-tendent l’éditeur Doxa, notamment les branches, les commits, les pull requests et les workflows de fusion."
...
|---|---|
| Modifier une page | Les modifications sont enregistrées automatiquement sur les serveurs Doxa (pas encore de commit Git) |
