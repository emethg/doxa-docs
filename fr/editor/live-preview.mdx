...
description: "Prévisualisez votre site de doc en temps réel pendant l'édition, avec des mises à jour qui rendent instantanément le contenu, la navigation et la configuration."
...
Cliquez sur le bouton d'aperçu en direct <Icon icon="play" /> dans la barre d'outils pour ouvrir un aperçu en direct dans un nouvel onglet.
...
Utilisez l'aperçu en direct pour obtenir un retour immédiat pendant l'édition. Lorsque vous devez partager des modifications avec votre équipe ou tester sur un autre appareil, utilisez un [déploiement de prévisualisation](https://www.doxa.com/docs/editor/branching-and-publishing#preview-your-changes).
