...
description: "Réordonnez les pages, ajoutez des groupes et gérez la structure de la barre latérale de votre documentation par glisser-déposer dans l'éditeur web de Doxa, sans modifier docs.json."
