...
description: "Configurez les instructions d'IA, les consignes pour les pull requests, les pull requests en brouillon et la méthode de fusion par défaut de l'éditeur web Doxa."
keywords: ["éditeur", "paramètres", "ai", "instructions", "publication", "pull request", "brouillon", "fusion"]
---
...
- **Les paramètres de publication** s'appliquent à toutes les personnes d'un déploiement et déterminent ce qui se passe lorsque vous committez des modifications et les transformez en pull requests.
...
Vous devez disposer d'un accès administrateur à votre déploiement Doxa pour modifier les paramètres de publication.
