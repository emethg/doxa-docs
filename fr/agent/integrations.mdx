...
1. Accédez à la page [Intégrations de l'agent](https://app.doxa.com/settings/organization/integrations) de votre tableau de bord.
2. Repérez l'intégration que vous souhaitez connecter.
3. Cliquez sur **Connect**.
4. Suivez les invites OAuth pour autoriser Doxa à accéder à votre compte.
