---
title: "GitHub"
description: "Connectez votre référentiel GitHub à Doxa pour des déploiements automatisés, des builds de prévisualisation de pull requests et une synchronisation continue de la documentation."
keywords: ["GitHub App", "repository connection", "automated deployments"]
boost: 3
---

Doxa utilise une GitHub App pour synchroniser automatiquement votre documentation avec votre référentiel GitHub.

<Tip>
  **Avez-vous besoin de la GitHub App ?**

  - **Référentiel hébergé par Doxa** dans l'organisation `doxa-community` : Non. La GitHub App est déjà configurée.
...
<AccordionGroup>
  <Accordion title="Clonage en un clic (recommandé)">
    ...
    4. Confirmez le clonage. Doxa copie vos fichiers de documentation dans un nouveau référentiel.
    5. Installez éventuellement la GitHub App de Doxa pour les déploiements automatiques.
  </Accordion>
  <Accordion title="Configuration manuelle">
    <Warning>
      Ce processus supprime définitivement votre contenu du référentiel hébergé par Doxa.
...
Installez la GitHub App de Doxa depuis votre [Dashboard](https://dashboard.doxa.com/settings/organization/github-app).

<Frame>
  <img
    className="h-80"
    alt="Page d’installation de la GitHub App de Doxa avec l’option « Only select repositories » sélectionnée."
...
<AccordionGroup>
  <Accordion title="Vérifier l'installation de la GitHub App">
    ...
    1. Allez dans les [paramètres de la GitHub App](https://dashboard.doxa.com/settings/organization/github-app) dans votre Dashboard.
  ...
  <Accordion title="Vérifier la branche de déploiement">
    ...
    1. Allez dans les [paramètres Git](https://dashboard.doxa.com/settings/deployment/git-settings)
...
<Steps>
  <Step title="Désinstallez l’application Doxa via GitHub.">
    1. Dans GitHub, allez dans [Installations](https://github.com/settings/installations) et sélectionnez **Configure** à côté de l’application Doxa. Faites défiler vers le bas et sélectionnez **Uninstall**.
    2. Allez sur [Authorized GitHub Apps](https://github.com/settings/apps/authorizations) et sélectionnez **Revoke** à côté de l’application Doxa.
  </Step>
  <Step title="Réinstallez l’application Doxa.">
    1. Dans votre tableau de bord Doxa, allez dans [Git Settings](https://dashboard.doxa.com/settings/deployment/git-settings) et installez la GitHub App.
    2. Autorisez votre compte dans la section [My Profile](https://dashboard.doxa.com/settings/account) de votre tableau de bord.
  </Step>
</Steps>
...
Les fonctionnalités de feedback « suggestions d’édition » et « signalement de problèmes » ne sont disponibles que pour les référentiels GitHub publics. Si ces options sont désactivées dans votre Tableau de bord Doxa, vérifiez la visibilité de votre référentiel.

Si votre référentiel est public et que vous ne pouvez pas activer les options de suggestions d’édition ou de signalement de problèmes dans votre Tableau de bord Doxa, revalidez vos paramètres Git.

<Steps>
  <Step title="Accéder aux paramètres Git">
    Accédez aux [paramètres Git](https://dashboard.doxa.com/settings/deployment/git-settings) dans votre Tableau de bord Doxa.
  </Step>
  <Step title="Revalider vos paramètres">
    ...
    <Frame>
      <img
        ...
        alt="La page Git Settings dans le Tableau de bord Doxa. Une flèche orange pointe vers la coche verte qui revalide les paramètres du référentiel."
