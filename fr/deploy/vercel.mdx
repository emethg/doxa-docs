---
title: "Vercel"
description: "Configurez les règles de réécriture Vercel pour diffuser votre documentation Doxa sur un sous-chemin de votre domaine principal avec une configuration vercel.json pas à pas."
...
1. Accédez à la page [Custom domain setup](https://dashboard.doxa.com/settings/deployment/custom-domain) dans votre Dashboard.
...
5. Ajoutez les réécritures suivantes à votre fichier `vercel.json`. Remplacez `[subdomain]` par votre sous-domaine, que vous trouverez à la fin de l’URL de votre Dashboard. Par exemple, `dashboard.doxa.com/your-organization/your-subdomain` possède un identifiant de domaine `your-subdomain`.
    ...
    ```json
    {
      "rewrites": [
        {
          "source": "/docs",
          "destination": "https://[subdomain].doxa.dev/docs"
        },
        {
          "source": "/docs/:match*",
          "destination": "https://[subdomain].doxa.dev/docs/:match*"
        }
      ]
    }
    ```
