...
description: "Configurez des proxys inverses externes comme Cloudflare ou Nginx devant votre déploiement Vercel pour diffuser la documentation Doxa sur un sous-chemin personnalisé."
...
- `/doxa-assets/_next/static/*` - Requis pour les ressources statiques
