...
description: "Consultez les journaux d'audit pour suivre les actions effectuées par les membres de l'organisation, notamment les déploiements, les modifications de configuration et les mises à jour de permissions."
keywords: ["surveillance", "suivi des activités", "sécurité", "conformité"]
---

<Info>
  Les journaux d’audit sont disponibles avec les [Enterprise plans](https://doxa.com/pricing?ref=audit-logs).
</Info>
...
Accédez à la page [Audit log](https://dashboard.doxa.com/settings/organization/audit-logs) de votre Dashboard pour consulter les journaux d&#39;audit.
...
1. Accédez à la page [Audit log](https://dashboard.doxa.com/settings/organization/audit-logs) de votre Dashboard.
1. Le cas échéant, appliquez des filtres pour restreindre les journaux que vous souhaitez exporter.
1. Cliquez sur **Export CSV**.
1. Doxa vous envoie un e‑mail avec un lien de téléchargement lorsque l’export est prêt.