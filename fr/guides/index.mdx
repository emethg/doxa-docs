---
title: "Guides"
description: "Parcourez des guides sur les meilleures pratiques de documentation, la stratégie de contenu, l'optimisation SEO, l'accessibilité et les workflows docs-as-code pour votre équipe."
boost: 3
---
...
* [Configurer l'automerge](/fr/guides/configure-automerge) : ajoutez l'application GitHub Doxa à la liste de contournement d'un ensemble de règles pour activer la fusion automatique des workflows.
* [Utiliser les workflows](/fr/guides/use-workflows) : choisissez le bon trigger de workflow, rédigez des instructions efficaces et obtenez des résultats cohérents grâce à la maintenance de contenu automatisée.
...
* [Mises en page personnalisées](/fr/guides/custom-layouts): Utilisez les modes de page et les composants pour créer des pages de destination et d'autres mises en page personnalisées.
...
Comprenez Git pour tirer le meilleur parti de Doxa et d&#39;une approche « docs-as-code » de la documentation.
...
Découvrez comment Doxa répond à différents cas d’utilisation et trouvez une solution adaptée à vos besoins.

* [Créer une documentation développeur](/fr/guides/developer-documentation) : Aidez vos utilisateurs à tirer le meilleur parti de votre produit ou de votre API grâce à une documentation développeur qui répond à leurs questions et leur permet de revenir rapidement à leurs tâches principales.
...
* [Créer un centre d’aide](/fr/guides/help-center) : Créez un centre d’aide en libre-service qui permet aux utilisateurs de trouver des réponses par eux-mêmes, réduit le volume de tickets et améliore la satisfaction client.
* [Créer un frontend personnalisé](/fr/guides/custom-frontend) : utilisez l’intégration Doxa Astro pour afficher votre documentation avec un frontend entièrement personnalisé.
