...
<Tip>
  Utilisez les [workflows](/workflows) pour automatiser les vérifications récurrentes comme identifier les pages avec de faibles scores de retour ou signaler les éléments de navigation qui reçoivent rarement des clics.
</Tip>

Pour configurer la navigation dans Doxa — onglets, groupes, ancres et ordre des pages — consultez la [référence de navigation](/fr/organize/navigation).
