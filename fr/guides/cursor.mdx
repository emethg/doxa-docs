...
sidebarTitle: "Cursor"
description: "Configurez Cursor avec des règles de projet pour rédiger une documentation Doxa conforme à votre guide de style, à l'utilisation des composants et aux conventions MDX."
keywords: ["Cursor", "Cursor rules", "project rules", "documentation IA", "documentation Cursor"]
---

Faites de Cursor un expert de la documentation qui connaît vos composants, votre guide de style et vos meilleures pratiques.

<div id="use-cursor-with-doxa">
  ## Utilisez Cursor avec Doxa
</div>
...
Cette règle fournit à Cursor du context pour formater correctement les composants Doxa et appliquer les meilleures pratiques de rédaction technique.
...
````mdx wrap
# Règle de rédaction technique Doxa

Vous êtes un assistant de rédaction IA spécialisé dans la création de documentation technique exceptionnelle utilisant les composants Doxa et suivant les meilleures pratiques de rédaction technique de l'industrie.
...
- Regroupez les informations connexes de manière logique avec des séparations de section claires
...
- Incluez des procédures de dépannage pour les points de défaillance probables
...
## Référence des composants Doxa

### docs.json

- Référez-vous au [schéma docs.json](https://doxa.com/docs.json) lors de la création du fichier docs.json et de la navigation du site
...
#### Conseil - Meilleures pratiques et astuces

<Tip>
Conseils d'expert, raccourcis ou meilleures pratiques qui augmentent les chances de réussite de l'utilisateur
</Tip>

#### Avertissement - Précautions importantes

<Warning>
Informations critiques concernant des problèmes potentiels, des changements incompatibles ou des actions destructrices
</Warning>

#### Info - Informations contextuelles neutres

<Info>
Informations de contexte ou annonces neutres
</Info>
...
<Card title="Limitation de débit" icon="clock" href="/rate-limits">
  Comprenez les limites de débit et les meilleures pratiques pour un usage à fort volume.
</Card>
</CardGroup>
...
Nombre maximal de résultats à retourner. Plage : 1-100.
</ParamField>
...
<Expandable title="Propriétés de l'utilisateur">
  ...
  Informations de profil de l'utilisateur incluant les détails personnels.
  
  <Expandable title="Détails du profil">
    <ResponseField name="first_name" type="string">
    Prénom de l'utilisateur tel qu'il a été saisi lors de l'inscription.
    </ResponseField>
...
Intégrez les vidéos YouTube en utilisant des iframes :
...
<Tooltip tip="Interface de programmation d'applications - protocoles pour construire des logiciels">
API
</Tooltip>
...
- Résolution des problèmes de temporisation d'authentification
</Update>
...
<div id="enhance-with-mcp-server">
  ## Améliorez avec un serveur MCP
</div>

Connectez le serveur MCP de Doxa à Cursor pour lui permettre de rechercher dans la documentation Doxa tout en vous aidant à écrire. Lorsque vous connectez le serveur MCP, Cursor interroge la documentation Doxa la plus récente pour obtenir du contexte, afin que vous n’ayez pas à quitter votre IDE pour la consulter.

Consultez [Model Context Protocol](/fr/ai/model-context-protocol#example%3A-connect-to-the-doxa-mcp-server) pour des instructions de configuration complètes.