...
description: "Hébergez votre base de connaissances interne sur Doxa pour centraliser les informations et améliorer la recherche."
...
Doxa fournit l&#39;infrastructure pour des bases de connaissances auxquelles toute votre équipe peut contribuer.
...
Si vous n’avez pas encore créé de projet Doxa, consultez le [Quickstart](/fr/quickstart) pour déployer votre site.
...
* Exportez en **Markdown** pour une migration simplifiée vers Doxa. (recommandé)
...
Configurez l’Assistant depuis votre [dashboard](https://dashboard.doxa.com/products/assistant/settings) :
...
Une base de connaissances reste fiable et à jour lorsque tout le monde peut la modifier, pas seulement les personnes qui l’ont mise en place. Doxa propose trois moyens pour permettre aux membres de l’équipe de contribuer rapidement à votre base de connaissances.
...
> @doxa Crée un guide pour configurer l’intégration Acme à partir de cette conversation.
