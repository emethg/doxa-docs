...
description: "Créez une documentation développeur qui aide les ingénieurs à s’intégrer à vos API, SDK et outils, avec des guides de démarrage rapide, des références et des guides."
...
Doxa fournit une infrastructure conçue pour la documentation développeur.
...
* **Blocs de code avec explications** : l’[Assistant](/fr/assistant/index) explique les exemples de code dans leur contexte, aidant les développeurs à comprendre les détails d’implémentation.
...
Si vous n&#39;avez pas encore créé de projet Doxa, consultez le [Démarrage rapide](/fr/quickstart) pour déployer votre site.

* Votre spécification d’API au format OpenAPI (si vous documentez une API)
* Un référentiel Git pour votre documentation
* Un accès administrateur à votre organisation Doxa
...
* Exportez en **Markdown** pour une migration simplifiée vers Doxa.
...
L&#39;Assistant aide les développeurs à trouver des réponses et à comprendre les exemples de code. Configurez-le depuis votre [dashboard](https://dashboard.doxa.com/products/assistant/settings).
...
Installez la [GitHub App](/fr/deploy/github) Doxa pour garder la documentation synchronisée avec votre base de code et faciliter les contributions.

<Steps>
  <Step title="Connectez votre référentiel">
    Associez votre référentiel GitHub dans le [Dashboard](https://dashboard.doxa.com). Cela active les déploiements automatiques lorsque vous poussez des modifications.
  </Step>
