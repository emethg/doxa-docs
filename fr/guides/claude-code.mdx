...
description: "Configurez Claude Code avec des instructions de projet dans CLAUDE.md pour rédiger, réviser et mettre à jour votre documentation Doxa en suivant votre guide de style."
...
- Se référer au [schéma docs.json](https://doxa.com/docs.json) lors de la construction du fichier docs.json et de la navigation du site
...
<AccordionGroup>
<Accordion title="Ai-je besoin d'un fichier CLAUDE.md pour utiliser Claude Code avec Doxa ?">
