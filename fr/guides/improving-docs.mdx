...
Les analyses de Doxa vous permettent de voir les scores de retours aux côtés des données de trafic. Utilisez cela pour prioriser :
...
<Tip>
  Utilisez les [workflows](/workflows) pour automatiser les améliorations récurrentes — comme ouvrir une pull request avec des corrections suggérées pour les pages signalées par de faibles scores de retours.
</Tip>
