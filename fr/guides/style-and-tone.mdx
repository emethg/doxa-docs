...
description: "Rédigez une doc technique claire et cohérente : conseils pratiques sur la voix, la structure, la terminologie et le ton pour la doc développeurs et produit."
...
Dans la documentation Doxa, le H1 de la page est généré automatiquement à partir de la propriété `title:` du frontmatter. N'ajoutez pas de H1 manuel dans le corps.
...
<Tip>
  Utilisez un [workflow](/workflows) pour exécuter un audit de style selon un calendrier ou chaque fois que des modifications sont poussées vers votre dépôt de documentation.
</Tip>
