...
description: "Apprenez les fondamentaux du contrôle de version avec Git pour les workflows docs-as-code, notamment les dépôts, les branches, les commits et la collaboration via les pull requests."
...
<Tabs>
  <Tab title="Avec l’éditeur web">
    1. Ouvrez le fichier dans l’[éditeur web](https://dashboard.doxa.com/editor).
