...
description: "Créez un centre d'aide en libre-service sur Doxa qui aide les clients à trouver des réponses, réduit le volume de tickets de support et évolue avec votre équipe."
...
Doxa fournit une infrastructure de centres de support qui évoluent avec la croissance de votre base de clientèle.
...
Cela crée un nouveau projet préconfiguré pour un centre d’assistance, comprenant la structure de navigation, des pages d’exemple et des listes de répertoires. Consultez l’[exemple en ligne](https://help-center-starter.doxa.app/) ou parcourez le [code source du modèle](https://github.com/doxa/templates/tree/main/help-center-starter).
...
Si vous n&#39;avez pas encore créé de projet Doxa, consultez le [Guide de démarrage rapide](/fr/quickstart) pour déployer votre site.

* Contenu pour vos sujets de support les plus fréquents
* Accès administrateur à votre organisation Doxa
...
* Exportez au format **Markdown** pour effectuer la migration la plus simple vers Doxa.
...
L&#39;Assistant répond aux questions des clients en utilisant votre contenu de support. Configurez-le depuis votre [Dashboard](https://dashboard.doxa.com/products/assistant/settings).
