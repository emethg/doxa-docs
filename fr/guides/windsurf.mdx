...
description: "Configurez Windsurf Cascade avec des workspace rules et des mémoires pour rédiger une documentation Doxa conforme à votre guide de style et aux standards MDX."
keywords: ["Windsurf", "Cascade", "workspace rules", "documentation IA", "documentation Windsurf"]
---
...
<div id="use-windsurf-with-doxa">
  ## Utilisez Windsurf avec Doxa
</div>

L’Assistant IA Cascade de Windsurf peut être paramétré pour rédiger une documentation conforme à vos standards en utilisant les composants Doxa. Les règles d’espace de travail et les mémoires fournissent un context persistant sur votre projet, garantissant des suggestions de Cascade plus cohérentes.
...
Cette règle fournit à Cascade du contexte sur les composants Doxa et les meilleures pratiques générales de rédaction technique.
...
- Il s'agit d'un projet de documentation sur la plateforme Doxa
...
- Référez-vous au [schéma docs.json](https://doxa.com/docs.json) lors de la construction du fichier docs.json et de la navigation du site
...
Connectez le serveur MCP de Doxa à Windsurf pour permettre à Cascade de rechercher dans la documentation Doxa tout en vous aidant à rédiger. Lorsque vous connectez le serveur MCP, Cascade interroge la documentation Doxa à jour pour obtenir du contexte, afin que vous n&#39;ayez pas à quitter votre IDE pour la consulter.

Consultez [Model Context Protocol](/fr/ai/model-context-protocol#example%3A-connect-to-the-doxa-mcp-server) pour obtenir des instructions complètes de configuration.