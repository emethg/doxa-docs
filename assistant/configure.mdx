...
description: "Configure the AI assistant in your Doxa dashboard: toggle availability, customize responses, add starter questions, set bot protection, and manage billing."
keywords: ["assistant", "settings", "deflection", "bot protection", "billing"]
---

Configure the assistant on the [Assistant](https://app.doxa.com/products/assistant) page of your dashboard. Manage billing and usage on the [Usage](https://app.doxa.com/settings/organization/usage) page.
...
<Frame>
  <img src="/images/assistant/deflection-light.png" alt="The assistant deflection panel in the dashboard. Assistant deflection is toggled on and support@doxa.com is set as the deflection email." className="block dark:hidden" />
  <img src="/images/assistant/deflection-dark.png" alt="The assistant deflection panel in the dashboard. Assistant deflection is toggled on and support@doxa.com is set as the deflection email." className="hidden dark:block" />
</Frame>
...
<Frame>
  <img src="/images/assistant/search-domains-light.png" alt="The assistant search domains panel enabled in the dashboard. The assistant is configured to search the doxa.com/pricing domain." className="block dark:hidden" />
  <img src="/images/assistant/search-domains-dark.png" alt="The assistant search domains panel enabled in the dashboard. The assistant is configured to search the doxa.com/pricing domain." className="hidden dark:block" />
</Frame>
...
1. Go to the [Assistant settings](https://app.doxa.com/products/assistant/settings) page in your dashboard.
...
1. Go to the [Usage](https://app.doxa.com/settings/organization/usage) page of your dashboard.
...
To allow overages, enable them in the **Spending controls** section of the [Usage](https://app.doxa.com/settings/organization/usage) page of your dashboard. If you enable overages, each credit beyond your allowance incurs an overage charge.
...
For plans larger than 10,000 credits per month, [contact sales](mailto:sales@doxa.com) to discuss custom credit packages.
