...
Pour utiliser des dépôts GitLab dans un workflow, connectez chaque projet via la page de paramètres [OAuth GitLab](https://app.doxa.com/settings/organization/gitlab-oauth). Connectez chaque dépôt que le workflow utilise — votre dépôt de documentation et tous les dépôts de déclenchement ou de contexte. Vous devez disposer au minimum du rôle Mainteneur sur chaque projet.
