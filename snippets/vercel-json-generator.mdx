export const VercelJsonGenerator = () => {
  ...
  const vercelConfig = {
    rewrites: [
      {
        source: "/_doxa/:path*",
        destination: `https://${subdomain}.doxa.app/_doxa/:path*`
      },
      {
        source: "/api/request",
        destination: `https://${subdomain}.doxa.app/_doxa/api/request`
      },
      {
        source: `/${subpath}`,
        destination: `https://${subdomain}.doxa.app/${subpath}`
      },
      {
        source: `/${subpath}/llms.txt`,
        destination: `https://${subdomain}.doxa.app/llms.txt`
      },
      {
        source: `/${subpath}/llms-full.txt`,
        destination: `https://${subdomain}.doxa.app/llms-full.txt`
      },
      {
        source: `/${subpath}/sitemap.xml`,
        destination: `https://${subdomain}.doxa.app/sitemap.xml`
      },
      {
        source: `/${subpath}/robots.txt`,
        destination: `https://${subdomain}.doxa.app/robots.txt`
      },
      {
        source: `/${subpath}/mcp`,
        destination: `https://${subdomain}.doxa.app/mcp`
      },
      {
        source: `/${subpath}/:path*`,
        destination: `https://${subdomain}.doxa.app/${subpath}/:path*`
      },
      {
        source: "/doxa-assets/:path+",
        destination: `https://${subdomain}.doxa.app/doxa-assets/:path+`
      }
    ]
  }
