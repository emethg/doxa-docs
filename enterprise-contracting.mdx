...
description: "How Doxa approaches enterprise legal review, MSA negotiations, security questionnaires, and procurement so you know what to expect when buying."
hidden: true
---
...
All Doxa Enterprise agreements go through legal review. Our goal is execution in under three business days.
...
<AccordionGroup>
  <Accordion title="1. Platform IP ownership">
    **Our position:** Doxa owns all platform code, features, and methods.
    Customers own all of their content and data.

    **Why:** Doxa is a multi-tenant platform serving thousands of customers. If any customer could claim ownership over platform features, we couldn't offer those features to anyone else and the platform would stop improving. We want Doxa to get better over time, not worse.
  ...
  <Accordion title="2. Aggregate data for product analytics">
    **Our position:** Doxa may use de-identified, aggregated usage data (feature usage, performance metrics, search patterns) for product analytics and improvement.
...
Reach out to your account executive or contact us at [legal@doxa.com](mailto:legal@doxa.com).

Our standard terms and compliance documentation are available at [doxa.com/legal/terms](https://www.doxa.com/legal/terms) and [security.doxa.com](https://security.doxa.com).
