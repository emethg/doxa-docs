...
- Config: docs.json for navigation, theme, settings
  - See the docs.json schema: https://doxa.com/docs.json
- Use Doxa components. If you ever need to learn how a component works, search in the docs/components/ dir
...
## Audience
- The Doxa audience is varied. Some people are highly technical and others are not
