...
description: "Connect your Doxa documentation to analytics platforms like Google Analytics, Mixpanel, PostHog, and more to track visitor engagement."
keywords: ["third-party analytics", "engagement tracking", "analytics platforms", "usage tracking"]
---

Track how users interact with your documentation by connecting to third-party analytics platforms. Doxa sends engagement events to your configured analytics providers.

## How analytics integrations work

When you add analytics integrations to your documentation site, Doxa tracks user interactions like page views, search queries, API playground requests, and feedback submissions and sends them to your analytics providers. You can connect any number of supported analytics providers by adding your API keys to the `docs.json` file. Analytics events flow to your providers as soon as you add them to your configuration with no further configuration required.
...
<CardGroup cols={2}>
  <Card
    ...
    href="/integrations/analytics/adobe"
    horizontal
    icon={
      <svg
        className="h-6 w-6"
  ...
  <Card
    ...
    horizontal
    icon={
      <svg width="161" height="162" className="h-6 w-6" viewBox="0 0 161 162" fill="none" xmlns="http://www.w3.org/2000/svg">
...
/>
  ...
  <Card
    ...
    horizontal
    icon={
      <svg className="h-6 w-6" width="24" height="24" xmlns="http://www.w3.org/2000/svg" viewBox="62.4 0 387.18 512">
...
| `docs.footer.powered_by_doxa_click` | User clicks the "Powered by Doxa" link.                                                        |
