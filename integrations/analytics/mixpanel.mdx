---
title: "Mixpanel"
description: "Integrate Mixpanel with your Doxa documentation site to track product analytics, user behavior funnels, and content engagement events."
...
Doxa automatically tracks the following user interactions:
