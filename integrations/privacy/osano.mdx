---
title: "Osano"
description: "Integrate Osano with your Doxa documentation site to manage cookie consent banners, privacy preferences, and regulatory compliance."
...
>
  If your documentation pages aren't loading properly when using Osano's **Strict** compliance mode, you'll need to add Doxa's domain to your allowlist to allow images and other assets to load.
  ...
  <Steps>
    ...
    <Step title="Add Doxa domain">
      Add `.doxa.app/` as a managed rule.
      ...
      <Info>
      This ensures that all Doxa-served assets (including images, stylesheets, and other documentation resources) are treated as essential and load even when Osano blocks uncategorized third-party content.
      </Info>
    </Step>
  </Steps>
</Accordion>
